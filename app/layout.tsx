...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','GTM-WLS465WG');
            `,
          }}
        />
      ...
      <body className={`${poppins.variable} ${lora.variable} ${rozhaOne.variable} font-poppins antialiased`}>{children}
        {/* GTM The noscript part (Optional but recommended) */}
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-WLS465WG"
            height="0"
            width="0"
